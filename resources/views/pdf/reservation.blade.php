...
@if($user_language_id == 4)
    ...
    $havalimanitransferi       = '24/7 Airport Delivery';
        ...
        <tr>
            <td>
                ...
                <table width="100%" style="border:1px solid #f1f1f1">
                    <tbody>
                    <tr>
                        <td width="50%" style="vertical-align:top;padding:10px 10px 10px 10px;border-right:1px solid #f1f1f1">
                            <div>
                                <?php if($image != "NULL"){ ?>
                                    <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('storage/uploads/'.$image))) }}" width="200" style="width: 200px;">
                                <?php }else{ ?>
                                <img
                            ...
                            <div style="text-align:center">
                                <span style="font-size: 15px;"> <b><?=$car['name']?></b> <?=$car['fuel']?> <?=$car['transmission']?></span>
                            </div>
                            <div  style="text-align:center">
                                <p class="plate"><span>TR</span> {{$plate}}</p>
                            </div>
                        </td>
                        <td width="50%" style="vertical-align:top;padding:10px 10px 10px 10px">
                            <table>
                                ...
                                <tr>
                                    <td style="font-size:15px">
                                        <b>{{$musteriID}} :</b> <?=$customer_id?>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size:15px">
                                        <b>{{$GeldiginizUlke}} :</b> <?=$nationality?>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size:15px">
                                        <b>{{$CepTelefonu}} :</b> <?php echo private_str($phone, 3, 11); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size:15px">
                                        <b>{{$emailAdres}} :</b>  <?php echo private_str($email, 5, 11); ?>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                ...
                <table width="100%" style="border:1px solid #f1f1f1">
                    ...
                    <tr>
                        ...
                        <td width="25%" style="color:#002655">
                            <div style="color:#002655;font-size:12px;padding:10px 10px 10px 10px"><b>{{$ToplamKiralamaSuresi}}
                                    :</b> <?=$reservationInfo->days?> <?=$gun?>
                            </div>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <tr>
                        <td style="width:50%">
                            <table width="100%" style="border-right:1px solid #f1f1f1">
                                ...
                                <tr>
                                    <td>
                                        <div style="color:#002655;font-size:13px;padding-left:10px"><b><u>{{$alisBilgileri}}</u></b></div>
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        <div style="color:#002655;font-size:12px;padding-left:10px"><b>{{$tarihsaat}} : </b><?=date('d-m-Y',strtotime($reservationInfo->checkin))?>  / <?=$reservationInfo->checkin_time?></div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                <?php
                                $reservationinformation = $reservationInfo->up_drop_information;
                                ...
                                ?>
                                     <span style="color:#000;font-weight: 700;">{{\App\Models\Location::getViewCenterId($item->reservationInformation->up_location ?? null)[0]->title ?? null}} </span>
                                     <span style="font-weight: 700;font-size:10px"> ( {!! \App\Models\Reservation::TYPE_TRANSLATIONS[$details['up']['type'] ?? \App\Models\Reservation::TYPE_TRANSLATIONS['up']] !!}   {!! $details['up']['key'] !!} {!! $details['up']['value'] !!} )</span>
                        ...
                        <td style="width:50%">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <div style="color:#002655;font-size:13px;padding-left:10px"><b><u>{{$donusbilgileri}}</u></b></div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <div style="color:#002655;font-size:12px;padding-left:10px"><b>{{$tarihsaat}}
                                                : </b><?=date('d-m-Y',strtotime($reservationInfo->checkout))?>
                                ...
                                <tr>
                                    ...
                                    {
                                    ?>
                                         <span style="color:#000;font-weight: 700;">{{\App\Models\Location::getViewCenterId($item->reservationInformation->drop_location ?? null)[0]->title ?? null}} </span>
                                         <span style="font-weight: 700;font-size:10px"> ( {!! \App\Models\Reservation::TYPE_TRANSLATIONS[$details['drop']['type'] ?? \App\Models\Reservation::TYPE_TRANSLATIONS['up']] !!}   {!! $details['drop']['key'] !!} {!! $details['drop']['value'] !!} )</span>
                                         <?php } ?>
                                    <?php } ?>
                                </tr>
                    ...
                    <tr>
                        <td style="padding-top:10px;padding-bottom:10px">
                            <table width="100%" style="border-left:1px solid #f1f1f1">
                                ...
                                <?php foreach($reservationEkstras as $item){ ?>
                                    <tr>
                                        <td width="60%">
                                            <div style="font-size:12px;padding-left:10px"> {{\App\Models\EkstraLanguage::getSelectLang($item->id_ekstra,'title',$user_language_id)}} : </div>
                                        </td>
                                        <td width="20%">
                                            <div style="font-size:12px;padding-left:10px">{{$item->item}} <?=$adet?>  (<?php if($item->item > 0){echo'<img style="width:10px;" src="data:image/png;base64,"/>';} ?>)</div>
                                        </td>
                                        <td width="20%">
                                            <div style="font-size:12px;padding-left:10px;border-right:1px solid #f1f1f1"> {{$item->price}} {{$currency}} </div>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                        ...
                        <td style="vertical-align:top;padding-top:10px;padding-bottom:10px">
                            <table width="100%" style="border-left:1px solid #f1f1f1">
                                ...
                                <tr>
                                    <td>
                                        <div style="font-size:12px;padding-left:10px;padding-top:2px"><b><?=$odemesekli?> :</b> {{ $reservation->getPaymentMethod()}}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div style="font-size:12px;padding-left:10px;padding-top:2px"><b><?=$gunlukucret?> :</b> {{round($reservation->day_price)}} {{$currency}} </div>
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        <div style="font-size:12px;padding-left:10px;padding-top:2px"><b><?=$kiralamaucreti?> :</b> {{round($reservation->rent_price)}} {{$currency}}
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <div style="font-size:12px;padding-left:10px;padding-top:2px"><b><?=$ekstraucreti?>  :</b> {{round($reservation->ekstra_price)}} {{$currency}}
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <div style="font-size:12px;padding-left:10px;padding-top:2px"><b><?=$testlimucreti?> :</b> {{round($reservation->drop_price)}} {{$currency}}
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div style="font-size:12px;padding-left:10px;padding-top:2px"><b><?=$alisucreti?> :</b> {{round($reservation->up_price)}} {{$currency}}
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div style="font-size:12px;padding-left:10px;padding-top:2px"><b><?=$geneltoplam?> : {{round($reservation->total_amount)}}  {{$currency}}</b></div>
                                    </td>
                                </tr>
                ...
                <table style="border-collapse:collapse;border-spacing:0;margin:10px 0;padding:0;text-align:left;vertical-align:top;width:100%">
                    <tbody>
                    <tr>
                        <td  colspan="6" style="width:100%;font-size: 16px;text-align:center"><b><?=$fiyatadahilhizmetler?></b></td>
                    </tr>
                    <tr>
                        <td style="width:auto;font-size: 12px;text-align:center"><?=$kaskosigortasi?>       <img style="width:10px;" src="data:image/png;base64,"/></td>
                        <td style="width:auto;font-size: 12px;text-align:center"><?=$farcamsigortasi?>      <img style="width:10px;" src="data:image/png;base64,"/></td>
                        <td style="width:auto;font-size: 12px;text-align:center"><?=$hirsizliksigortasi?>   <img style="width:10px;" src="data:image/png;base64,"/></td>
                        <td style="width:auto;font-size: 12px;text-align:center"><?=$havalimanitransferi?>  <img style="width:10px;" src="data:image/png;base64,"/></td>
                        <td style="width:auto;font-size: 12px;text-align:center"><?=$kdvdahil?>             <img style="width:10px;" src="data:image/png;base64,"/></td>
                        <td style="width:auto;font-size: 12px;text-align:center"><?=$yolyardimi?>           <img style="width:10px;" src="data:image/png;base64,"/></td>
                    </tr>
                    </tbody>
                </table>
                <table width="100%" style="border:1px solid #f1f1f1">
            ...
            <table style="border-collapse:collapse;border-spacing:0;margin:10px 0;padding:0;text-align:left;vertical-align:top;width:100%">
                ...
                <tr style="padding:0;text-align:left;vertical-align:top">
                    <th style="margin:0;font-size:14px;font-weight:400;line-height:1.1;padding:0;text-align:left">
                        <div style="font-size:12px;line-height:1.4;text-align:center"> WORLD SEY. TUR.iNŞ.iTH.iHR.TiC.LTD.ŞTi . Copyright 2015 - <?=date('Y')?> </div>
                        <div style="margin-top:3px;text-align:center"><a href="#" style="margin:0;color:#8a8a8a;display:inline-block;font-size:12px;font-weight:400;line-height:1.4;padding:0;text-align:center;text-decoration:none" rel="noreferrer" target="_blank"> Saray Mah Ataturk Cad Antalya - Alanya, 07400</a></div>
                    </th>
                </tr>
