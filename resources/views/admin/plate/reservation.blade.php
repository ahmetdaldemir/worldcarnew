                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered table-gray-300 ">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" style="width: 27%">Checkin</th>
                                ...
                                <tr style="@if($item->status == 30) background:#0b93ff;color:#fff @endif">
                                    ...
                                    <td style="text-align:left;"><strong>{{$item->day_price}}</strong>  {{$item->current->left_icon}}</td>
                                    <td style="text-align:left;"><strong>{{$item->ekstra_price}}</strong>   {{$item->current->left_icon}}</td>
                                    <td style="text-align:left;"><strong>{{$item->up_price}}</strong>   {{$item->current->left_icon}}</td>
                                    <td style="text-align:left;"><strong>{{$item->drop_price}}</strong>   {{$item->current->left_icon}}</td>
                                    <td style="text-align:left;"><strong>{{$item->total_amount}}</strong>   {{$item->current->left_icon}}</td>
                                </tr>
                                    <?php $i++;
                                } ?>
                                </tbody>
