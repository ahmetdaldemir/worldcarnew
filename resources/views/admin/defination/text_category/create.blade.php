    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="post" action="{{route('admin.admin.text_category.save')}}" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        <div class="col-md-12">
                            <div class="row">
                                            ...
                                            @foreach($languages as $item)
                                                <div class="tab-pane fade @if($item->id == '1') active show @endif"
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control" name="title[]" id="location-title"  placeholder="{{$item->title}} Bölge Adı"/>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
