                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select class="form-control" name="category">
                                            ...
                                            <option @if($text->category == $item->id) selected @endif value="{{$item->id}}">{{$item->getLangTitle()}}</option>
                                            <?php } ?>
                                        </select>
                                        </select>
                                    </div>
                                            ...
                                            @foreach($languages as $item)
                                                <div class="tab-pane fade @if($item->id == '1') active show @endif"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="meta_title[]" id="location-meta_title"  value="{{ TextLanguage::getSelectLang($id,"meta_title",$item->id)}}"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Meta Açıklaması</label>
                                                        <textarea class="form-control" name="short_description[]" id="location-title"  placeholder="{{$item->short_description}} Meta Açıklaması"> {{ TextLanguage::getSelectLang($id,"short_description",$item->id)}}</textarea>
                                                    </div>
                                                    <div class="form-group">
                                    ...
                                    <div class="form-group" style="height: 60px">
                                        ...
                                        <img src="{{asset('/storage')}}/{{TextLanguage::getImage($id)}}"  style="width: 50px;  float: right;">
                                    </div>
                                    ...
                                    <div class="form-group" style="height: 60px">
                                        ...
                                        <img src="{{asset('/storage')}}/{{TextLanguage::getHeaderImage($id)}}"  style="width: 50px;  float: right;">
                                    </div>
                                </div>
                            </div>
                        </div>
