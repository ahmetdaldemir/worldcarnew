                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="btn-group" role="group" style="float: right;margin: 10px 0px 10px 0;">
                            <a href="{{route('admin.admin.texts.create')}}" class="btn btn-primary" ><i class="i-Add"></i> Yeni Ekle</a>
                            ...
                            @if(isset($texts))
                                @foreach($texts as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.admin.texts.edit',['id'=>$item->id])}}" class="btn btn-success ">
                                                <i class="nav-icon i-Pen-2 "></i>
                                            </a>
                                            <a href="{{route('admin.admin.texts.delete',['id'=>$item->id])}}" class="btn btn-danger ">
