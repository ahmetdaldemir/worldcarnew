        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div style="margin-top: 10px;margin-bottom: 10px" class="card-body">
                        <form method="POST" action="{{ route('admin.admin.supplier.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Web Page') }}</label>
                                <div class="col-md-6">
                                    <input id="webpage" type="text" class="form-control @error('webpage') is-invalid @enderror" name="webpage" value="{{ old('webpage') }}" required>
