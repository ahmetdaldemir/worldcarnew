    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <form method="post" action="{{route('admin.admin.categories.update')}}" enctype="multipart/form-data">
                                            ...
                                            @foreach($languages as $item)
                                                <div class="tab-pane fade @if($item->id == '1') active show @endif"
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control" name="title[]" id="location-title"   value="{{  \App\Models\CategoryLanguage::getSelectLang($id,"title",$item->id)}}" />
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
