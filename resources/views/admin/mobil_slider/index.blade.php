                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="btn-group" role="group" style="float: right;margin: 10px 0px 10px 0;">
                            <a   class="btn btn-primary" href="{{route('admin.admin.mobil_slider.create')}}"><i class="i-Add"></i> Resim Ekle</a>
                        ...
                        <table class="table table-sm table-gray-300 ">
                            ...
                            @foreach($MobilSliders as $item)
                                <tr>
                                    ...
                                    <td>{{$item->image}}</td>
                                    <td>
                                        <a   href="{{route('admin.admin.car_model',['id'=>$item->id])}}" class="btn btn-warning ">
                                            Model
                                        </a>
                                        <a   href="{{route('admin.admin.brand.edit',['id'=>$item->id])}}" class="btn btn-success ">
                                            <i class="nav-icon i-Pen-2 "></i>
                                        </a>
                                        <a href="{{route('admin.admin.brand.delete',['id'=>$item->id])}}" class="btn btn-danger ">
