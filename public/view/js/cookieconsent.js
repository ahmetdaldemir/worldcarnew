...
(function(scope){
    ...
    // $(document.getElementById("#modal_more_btn"), 'click', function(){
    //     show_policy(20);
    // });
    //
    // function show_policy(cc_delay){
    //     setTimeout(function() {
    //
    //
    //         $(".cc_policy_container").addClass('cc__anim');
    //         $(".cc_policy_container").addClass('cc__show');
    //
    ...
    var CookieConsent = function(){
        ...
        var _createCookieConsentPolicyHTML = function(){
            ...
            if(_cc_modal_isAttached){
                $(document.getElementById(_config.cc_ids.modal_more_btn), 'click', function(){
                    alert("Deneme");
