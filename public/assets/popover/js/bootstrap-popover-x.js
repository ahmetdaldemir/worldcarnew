...
(function (factory) {
    ...
    PopoverButton.prototype = {
        ...
        listen: function (ev) {
            var self = this, $el = self.$element, $dialog = self.$dialog, isHover = true, evIn, evOut,
                href = self.href;
            if (ev === 'manual') {
                return;
            }
    ...
    PopoverX.prototype = {
        ...
        init: function () {
            ...
            $dialog.on('hover.dismiss' + $h.NAMESPACE, '[data-dismiss="popover-x"]', $.proxy(self.hide, self));
    ...
    $.fn.popoverButton.defaults = {trigger: 'hover keyup'};
