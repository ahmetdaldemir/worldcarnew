 ...
 * $teminalNo = "VP195680";
 * $kartNo = "5556600110194317";
 * $expiryDate = "0630";
 * $ccv = "582";
 * $amount = "1.00";
 * $installmentCount = 1;
 * $currency = 949;
 * $brand = 200; checkourSucces checkoutFail
 */
class  Vakifbank
{
    /**
    ...
    {
        $data = [
            'MerchantId'              => "000000000159616",
            'Password'                => "k5LKd04Y",
            'TerminalNo'              => "VP195680",
            'TransactionType'         => 'Sale',
            'TransactionId'           => $request->VerifyEnrollmentRequestId,
            'MpiTransactionId'        => $request->VerifyEnrollmentRequestId,
            'OrderId'                 => $request->VerifyEnrollmentRequestId,
